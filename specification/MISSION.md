...
- Planned but not early: the **emotion face** (from v2), **additional hardware** beyond Echo Base (Echo Pyramid v2.7, Cardputer ADV v2.8, AtomS3R Camera v3.7, Core S3 v3.8), **vision/camera** (v3.7), and **web search** (v3.5). Each lands in its version, not before.
