...
- [specification/ROADMAP.md](specification/ROADMAP.md) — the v0–v7 plan (phases, goals, tasks, DoD).
...
- **[specification/ROADMAP.md](specification/ROADMAP.md)** — the full v0–v7 plan.
