...
- `/release-version 0.2.0 Add I2S audio loop; Migrate firmware to PlatformIO` -- bump with provided changelog items
...
3. Summarize the changes into concise bullet points (group related commits; reference the pyramid phase `vA.B` where relevant)
...
- **Don't modify source files.** This skill only touches version metadata, not firmware, server, mcp, or console code.
